...
def run(dataFrame):
    ...
    def buttonmodefunc():
        ...
        l1=Label(root,text=c,bg="white",fg="black",width="100",height="2")
        l1.place(x=670,y=30)
    ...
    def buttonmedianfunc():
        ...
        l2=Label(root,text=c,bg="white",fg="black",width="100",height="2")
    ...
    def buttonmeanfunc():
        ...
        l3=Label(root,text=c,bg="white",fg="black",width="100",height="2")
        l3.place(x=670,y=330)

    def buttonvariancefunc():
        c=stats.variance(df["data"])
        lab1=Label(root,text="Standard Deviation=",bg="white",fg="black",width="20",height="2")
    ...
    def buttonpvariancefunc():
        ...
        lab1=Label(root,text="variance=",bg="white",fg="black",width="10",height="2")
